 ...
 */
export const STYLE_PERIMETER = 'perimeter';
 ...
 * Value is "sourcePort".
 */
export const STYLE_SOURCE_PORT = 'sourcePort';
 ...
 * Value is "targetPort".
 */
export const STYLE_TARGET_PORT = 'targetPort';
 ...
 * "portConstraint".
 */
export const STYLE_PORT_CONSTRAINT = 'portConstraint';
 ...
 */
export const STYLE_PORT_CONSTRAINT_ROTATION = 'portConstraintRotation';
 ...
 */
export const STYLE_SOURCE_PORT_CONSTRAINT = 'sourcePortConstraint';
 ...
 */
export const STYLE_TARGET_PORT_CONSTRAINT = 'targetPortConstraint';
 ...
 */
export const STYLE_OPACITY = 'opacity';
 ...
 */
export const STYLE_FILL_OPACITY = 'fillOpacity';
 ...
 */
export const STYLE_STROKE_OPACITY = 'strokeOpacity';
 ...
 */
export const STYLE_TEXT_OPACITY = 'textOpacity';
 ...
 */
export const STYLE_TEXT_DIRECTION = 'textDirection';
 ...
 */
export const STYLE_OVERFLOW = 'overflow';
 ...
 */
export const STYLE_ORTHOGONAL = 'orthogonal';
 ...
 */
export const STYLE_EXIT_X = 'exitX';
 ...
 */
export const STYLE_EXIT_Y = 'exitY';
 ...
 */
export const STYLE_EXIT_DX = 'exitDx';
 ...
 */
export const STYLE_EXIT_DY = 'exitDy';
 ...
 */
export const STYLE_EXIT_PERIMETER = 'exitPerimeter';
 ...
 */
export const STYLE_ENTRY_X = 'entryX';
 ...
 */
export const STYLE_ENTRY_Y = 'entryY';
 ...
 */
export const STYLE_ENTRY_DX = 'entryDx';
 ...
 */
export const STYLE_ENTRY_DY = 'entryDy';
 ...
 */
export const STYLE_ENTRY_PERIMETER = 'entryPerimeter';
 ...
 */
export const STYLE_WHITE_SPACE = 'whiteSpace';
 ...
 */
export const STYLE_ROTATION = 'rotation';
 ...
 */
export const STYLE_FILLCOLOR = 'fillColor';
 ...
 */
export const STYLE_POINTER_EVENTS = 'pointerEvents';
 ...
 */
export const STYLE_SWIMLANE_FILLCOLOR = 'swimlaneFillColor';
 ...
 * "gradientColor".
 */
export const STYLE_GRADIENTCOLOR = 'gradientColor';
 ...
 */
export const STYLE_GRADIENT_DIRECTION = 'gradientDirection';
 ...
 */
export const STYLE_STROKECOLOR = 'strokeColor';
 ...
 */
export const STYLE_SEPARATORCOLOR = 'separatorColor';
 ...
 */
export const STYLE_STROKEWIDTH = 'strokeWidth';
 ...
 */
export const STYLE_ALIGN = 'align';
 ...
 */
export const STYLE_LABEL_WIDTH = 'labelWidth';
 ...
 */
export const STYLE_LABEL_POSITION = 'labelPosition';
 ...
 */
export const STYLE_VERTICAL_LABEL_POSITION = 'verticalLabelPosition';
 ...
 */
export const STYLE_IMAGE_ASPECT = 'imageAspect';
 ...
 */
export const STYLE_IMAGE_ALIGN = 'imageAlign';
 ...
 */
export const STYLE_IMAGE_VERTICAL_ALIGN = 'imageVerticalAlign';
 ...
 * "glass".
 */
export const STYLE_GLASS = 'glass';
 ...
 * Value is "imageWidth".
 */
export const STYLE_IMAGE_WIDTH = 'imageWidth';
 ...
 */
export const STYLE_IMAGE_HEIGHT = 'imageHeight';
 ...
 */
export const STYLE_IMAGE_BACKGROUND = 'imageBackground';
 ...
 */
export const STYLE_IMAGE_BORDER = 'imageBorder';
 ...
 * "flipH".
 */
export const STYLE_FLIPH = 'flipH';
 ...
 */
export const STYLE_FLIPV = 'flipV';
 ...
 */
export const STYLE_NOLABEL = 'noLabel';
 ...
 */
export const STYLE_NOEDGESTYLE = 'noEdgeStyle';
 ...
 */
export const STYLE_LABEL_BACKGROUNDCOLOR = 'labelBackgroundColor';
 ...
 */
export const STYLE_LABEL_BORDERCOLOR = 'labelBorderColor';
 ...
 */
export const STYLE_LABEL_PADDING = 'labelPadding';
 ...
 */
export const STYLE_INDICATOR_SHAPE = 'indicatorShape';
 ...
 */
export const STYLE_INDICATOR_IMAGE = 'indicatorImage';
 ...
 * "indicatorColor".
 */
export const STYLE_INDICATOR_COLOR = 'indicatorColor';
 ...
 */
export const STYLE_INDICATOR_STROKECOLOR = 'indicatorStrokeColor';
 ...
 */
export const STYLE_INDICATOR_GRADIENTCOLOR = 'indicatorGradientColor';
 ...
 * "indicatorSpacing".
 */
export const STYLE_INDICATOR_SPACING = 'indicatorSpacing';
 ...
 */
export const STYLE_INDICATOR_WIDTH = 'indicatorWidth';
 ...
 */
export const STYLE_INDICATOR_HEIGHT = 'indicatorHeight';
 ...
 */
export const STYLE_INDICATOR_DIRECTION = 'indicatorDirection';
 ...
 * Value is "shadow".
 */
export const STYLE_SHADOW = 'shadow';
 ...
 */
export const STYLE_SEGMENT = 'segment';
 ...
 * (end)
 */
export const STYLE_ENDARROW = 'endArrow';
 ...
 */
export const STYLE_STARTARROW = 'startArrow';
 ...
 * "endSize".
 */
export const STYLE_ENDSIZE = 'endSize';
 ...
 * Value is "startSize".
 */
export const STYLE_STARTSIZE = 'startSize';
 ...
 */
export const STYLE_SWIMLANE_LINE = 'swimlaneLine';
 ...
 * "endFill".
 */
export const STYLE_ENDFILL = 'endFill';
 ...
 * "startFill".
 */
export const STYLE_STARTFILL = 'startFill';
 ...
 */
export const STYLE_DASHED = 'dashed';
 ...
 */
export const STYLE_DASH_PATTERN = 'dashPattern';
 ...
 */
export const STYLE_FIX_DASH = 'fixDash';
 ...
 * "rounded".
 */
export const STYLE_ROUNDED = 'rounded';
 ...
 */
export const STYLE_CURVED = 'curved';
 ...
 */
export const STYLE_ARCSIZE = 'arcSize';
 ...
 */
export const STYLE_ABSOLUTE_ARCSIZE = 'absoluteArcSize';
 ...
 */
export const STYLE_SOURCE_PERIMETER_SPACING = 'sourcePerimeterSpacing';
 ...
 */
export const STYLE_TARGET_PERIMETER_SPACING = 'targetPerimeterSpacing';
 ...
 * "perimeterSpacing".
 */
export const STYLE_PERIMETER_SPACING = 'perimeterSpacing';
 ...
 */
export const STYLE_SPACING = 'spacing';
 ...
 */
export const STYLE_SPACING_TOP = 'spacingTop';
 ...
 */
export const STYLE_SPACING_LEFT = 'spacingLeft';
 ...
 */
export const STYLE_SPACING_BOTTOM = 'spacingBottom';
 ...
 */
export const STYLE_SPACING_RIGHT = 'spacingRight';
 ...
 */
export const STYLE_HORIZONTAL = 'horizontal';
 ...
 */
export const STYLE_DIRECTION = 'direction';
 ...
 */
export const STYLE_ANCHOR_POINT_DIRECTION = 'anchorPointDirection';
 ...
 */
export const STYLE_ELBOW = 'elbow';
 ...
 */
export const STYLE_FONTCOLOR = 'fontColor';
 ...
 * Value is fontFamily.
 */
export const STYLE_FONTFAMILY = 'fontFamily';
 ...
 */
export const STYLE_FONTSIZE = 'fontSize';
 ...
 */
export const STYLE_FONTSTYLE = 'fontStyle';
 ...
 */
export const STYLE_ASPECT = 'aspect';
 ...
 */
export const STYLE_AUTOSIZE = 'autosize';
 ...
 */
export const STYLE_FOLDABLE = 'foldable';
 ...
 */
export const STYLE_EDITABLE = 'editable';
 ...
 */
export const STYLE_BACKGROUND_OUTLINE = 'backgroundOutline';
 ...
 */
export const STYLE_BENDABLE = 'bendable';
 ...
 */
export const STYLE_MOVABLE = 'movable';
 ...
 */
export const STYLE_RESIZABLE = 'resizable';
 ...
 * is "resizeWidth".
 */
export const STYLE_RESIZE_WIDTH = 'resizeWidth';
 ...
 * is "resizeHeight".
 */
export const STYLE_RESIZE_HEIGHT = 'resizeHeight';
 ...
 */
export const STYLE_ROTATABLE = 'rotatable';
 ...
 */
export const STYLE_CLONEABLE = 'cloneable';
 ...
 */
export const STYLE_DELETABLE = 'deletable';
 ...
 */
export const STYLE_EDGE = 'edgeStyle';
 ...
 * Value is "jettySize".
 */
export const STYLE_JETTY_SIZE = 'jettySize';
 ...
 */
export const STYLE_SOURCE_JETTY_SIZE = 'sourceJettySize';
 ...
 */
export const STYLE_TARGET_JETTY_SIZE = 'targetJettySize';
 ...
 */
export const STYLE_LOOP = 'loopStyle';
 ...
 */
export const STYLE_ORTHOGONAL_LOOP = 'orthogonalLoop';
 ...
 * "routingCenterX".
 */
export const STYLE_ROUTING_CENTER_X = 'routingCenterX';
 ...
 * "routingCenterY".
 */
export const STYLE_ROUTING_CENTER_Y = 'routingCenterY';
