...
Sidebar.prototype.init = function () {
  ...
  this.addStencilPalette('arrows', Translations.get('arrows'), dir + '/arrows.xml', ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
 ...
 */
Sidebar.prototype.collapsedImage = !Client.IS_SVG
 ...
 * Sets the default font size.
 */
Sidebar.prototype.expandedImage = !Client.IS_SVG
 ...
 *
 */
Sidebar.prototype.searchImage = !Client.IS_SVG
      ...
      let show = () => {
        ...
        let top =
          Math.min(
            ...
            Math.max(0, this.editorUi.container.offsetTop + this.container.offsetTop + elt.offsetTop - this.container.scrollTop - height / 2 + 16)
          ) + off.y;
...
Sidebar.prototype.addMiscPalette = function (expand) {
  ...
  let fns = [
    ...
    this.createVertexTemplateEntry(
      'label;whiteSpace=wrap;html=1;align=center;verticalAlign=bottom;spacingLeft=0;spacingBottom=4;imageAlign=center;imageVerticalAlign=top;image=' + this.gearImage,
      120,
      80,
      'Label',
      'Label 2',
    ...
    this.addEntry('shape group container', function () {
      let cell = new Cell('Label', new Geometry(0, 0, 160, 70), 'html=1;whiteSpace=wrap;container=1;recursiveResize=0;collapsible=0;');
      cell.vertex = true;
...
Sidebar.prototype.addUmlPalette = function (expand) {
  ...
  let field = new Cell(
    '+ field: type',
    new Geometry(0, 0, 100, 26),
    'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;'
  );
  field.vertex = true;

  let divider = new Cell(
    '',
    new Geometry(0, 0, 40, 8),
  ...
  let fns = [
    ...
    this.addEntry(dt + 'item member method function variable field attribute label', function () {
      let cell = new Cell(
        'item: attribute',
        new Geometry(0, 0, 120, field.geometry.height),
    ...
    this.addEntry(dt + 'object instance', function () {
      let cell = new Cell(
        '<p style="margin:0px;margin-top:4px;text-align:center;">' + '<b>Class</b></p>' + '<hr size="1"/><div style="height:2px;"></div>',
        new Geometry(0, 0, 140, 60),
        'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;'
      );
      cell.vertex = true;
    ...
    this.addEntry('uml activity state start', function () {
      let cell = new Cell('', new Geometry(0, 0, 30, 30), 'ellipse;html=1;shape=startState;fillColor=#000000;strokeColor=#ff0000;');
      cell.vertex = true;
    ...
    this.addEntry(dt + 'classifier', function () {
      ...
      var cell2 = new Cell('', new Geometry(0, 0, 140, 140), 'strokeColor=none;fillColor=none;');
      cell2.vertex = true;
      cell1.insert(cell2);

      var field2 = new Cell('property1', new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
      field2.geometry.relative = true;
      field2.geometry.offset = new Point(20, 20);
      field2.vertex = true;
      cell2.insert(field2);

      var field3 = new Cell('property2', new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
    ...
    this.addEntry(dt + 'classifier', function () {
      ...
      var cell2 = new Cell('', new Geometry(0, 0, 140, 50), 'strokeColor=none;fillColor=none;');
      cell2.vertex = true;
      cell1.insert(cell2);

      var field3 = new Cell('instance2', new Geometry(0, 0, 80, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
      field3.geometry.relative = true;
    ...
    this.addEntry(dt + 'classifier', function () {
      var cell1 = new Cell('0..1', new Geometry(0, 0, 120, 50), 'align=right;verticalAlign=top;spacingRight=2;');
      cell1.vertex = true;
      var field1 = new Cell(
        'Property1',
        new Geometry(0, 1, 120, 30),
    ...
    this.addEntry(dt + 'classifier', function () {
      ...
      var field1 = new Cell(
        'Collaboration1',
        new Geometry(0, 0, 270, 30),
        'html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;rotatable=0;points=[[0,0.5],[1,0.5]];resizeWidth=1;'
      );
      field1.vertex = true;
      cell1.insert(field1);

      var divider1 = new Cell(
        '',
        new Geometry(0.145, 0, 192, 8),
      ...
      var field2 = new Cell('Classifier1', new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
      field2.geometry.relative = true;
      field2.geometry.offset = new Point(85, 50);
      field2.vertex = true;
      cell1.insert(field2);

      var field3 = new Cell('Collaboration use 1', new Geometry(0, 0, 140, 30), 'shape=ellipse;html=1;align=center;verticalAlign=middle;rotatable=0;dashed=1;');
      field3.geometry.relative = true;
      ...
      var field4 = new Cell('Classifier2', new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
    ...
    this.addEntry(dt + 'region', function () {
      var cell1 = new Cell('', new Geometry(60, 0, 10, 100), 'line;strokeWidth=1;direction=south;html=1;dashed=1;dashPattern=20 20;');
      cell1.vertex = true;

      var cell2 = new Cell('Region 1', new Geometry(0, 40, 60, 20), 'text;align=right;');
      cell2.vertex = true;

      var cell3 = new Cell('Region 2', new Geometry(70, 40, 60, 20), 'text;align=left;');
      cell3.vertex = true;
    ...
    this.addEntry(dt + 'State', function () {
      ...
      var field1 = new Cell('', new Geometry(0, 0, 140, 50), 'fillColor=none;strokeColor=none;container=1;collapsible=0;');
      field1.vertex = true;
      cell1.insert(field1);

      var field2 = new Cell('State2', new Geometry(30, 10, 80, 30), 'html=1;align=center;verticalAlign=middle;rounded=1;absoluteArcSize=1;arcSize=10;');
      field2.vertex = true;
      field1.insert(field2);

      cell1.insert(divider.clone());

      var field3 = new Cell('behavior1', new Geometry(0, 0, 140, 25), 'fillColor=none;strokeColor=none;align=left;verticalAlign=middle;spacingLeft=5;');
      field3.vertex = true;
      cell1.insert(field3);

      cell1.insert(divider.clone());

      var field4 = new Cell('transition1', new Geometry(0, 0, 140, 25), 'fillColor=none;strokeColor=none;align=left;verticalAlign=middle;spacingLeft=5;');
      field4.vertex = true;
      cell1.insert(field4);
    ...
    this.addEntry(dt + 'State', function () {
      ...
      var field1 = new Cell('Entry1', new Geometry(0, 40, 50, 20), 'text;verticalAlign=middle;align=center;');
      field1.vertex = true;
      cell1.insert(field1);
    ...
    this.addEntry(dt + 'State', function () {
      ...
      var field1 = new Cell('Exit1', new Geometry(0, 40, 50, 20), 'text;verticalAlign=middle;align=center;');
      field1.vertex = true;
      cell1.insert(field1);
...
Sidebar.prototype.createThumb = function (cells, width, height, parent, title, showLabel, showTitle, realWidth, realHeight) {
  ...
  let s = Math.floor(Math.min((width - 2 * this.thumbBorder) / bounds.width, (height - 2 * this.thumbBorder) / bounds.height) * 100) / 100;
  ...
  if (this.graph.dialect == mxConstants.DIALECT_SVG && !Client.NO_FO && this.graph.view.getCanvas().ownerSVGElement != null) {
...
Sidebar.prototype.createItem = function (cells, title, showLabel, showTitle, width, height, allowCellsInserted) {
  ...
  if (cells.length > 1 || cells[0].vertex) {
    let ds = this.createDragSource(elt, this.createDropHandler(cells, true, allowCellsInserted, bounds), this.createDragPreview(width, height), cells, bounds);
    ...
    let ds = this.createDragSource(elt, this.createDropHandler(cells, false, allowCellsInserted, bounds), this.createDragPreview(width, height), cells, bounds);
    this.addClickHandler(elt, ds, cells);
  }
...
Sidebar.prototype.updateShapes = function (source, targets) {
  ...
  try {
    ...
    for (let i = 0; i < targets.length; i++) {
      ...
      if (targetCell.isVertex() == source.isVertex() || targetCell.isEdge() == source.isEdge()) {
        ...
        if (style.shape == 'umlLifeline' && sourceCellStyle.shape != 'umlLifeline') {
...
Sidebar.prototype.dropAndConnect = function (source, targets, direction, dropCellIndex, evt) {
  ...
  if (geo != null) {
    ...
    try {
      ...
      let useParent = !graph.isTableRow(source) && !graph.isTableCell(source) && (source.isEdge() || (sourceGeo != null && !sourceGeo.relative && validLayout));

      let tempTarget = graph.getCellAt(
      ...
      if (source.isEdge()) {
        ...
        if (geo3.getTerminalPoint(false) != null) {
          ...
          let offset = tmpState.cell != graph.view.currentRoot ? tmpState.origin : new Point(0, 0);
...
Sidebar.prototype.getDropAndConnectGeometry = function (source, target, direction, targets) {
  ...
  if (geo != null && geo2 != null) {
    ...
    if (source.isEdge()) {
      ...
      if (target.isEdge() && geo2.getTerminalPoint(true) != null && geo2.getTerminalPoint(false) != null) {
        ...
        if (target.isEdge() && geo2.getTerminalPoint(true) != null && target.getTerminal(false) != null) {
...
Sidebar.prototype.isDropStyleEnabled = function (cells, firstVertex) {
  ...
  if (firstVertex != null && cells.length == 1) {
    ...
    if (vstyle != null) {
      result = getValue(vstyle, 'strokeColor', mxConstants.NONE) != mxConstants.NONE || getValue(vstyle, 'fillColor', mxConstants.NONE) != mxConstants.NONE;
    }
  }
...
Sidebar.prototype.createDragSource = function (elt, dropHandler, preview, cells, bounds) {
  ...
  for (let i = 0; i < cells.length; i++) {
    if (firstVertex == null && cells[i].isVertex()) {
      firstVertex = i;
    } else if (freeSourceEdge == null && cells[i].isEdge() && cells[i].getTerminal(true) == null) {
      freeSourceEdge = i;
    }
  ...
  dragSource.dragOver = function (graph, evt) {
    ...
    if (this.previewElement != null) {
      ...
      } else if (dragSource.currentHighlight.state != null && dragSource.currentHighlight.state.cell.isEdge()) {
  ...
  dragSource.getDropTarget = (graph, x, y, evt) => {
    ...
    if (cell != null && !cell.isConnectable() && !cell.isEdge()) {
    ...
    if (
      ...
      ((state.cell.isVertex() && firstVertex != null) || (state.cell.isEdge() && cells[0].isEdge()))
    ) {
      currentStyleTarget = state;
      let tmp = state.cell.isEdge() ? graph.view.getPoint(state) : new Point(state.getCenterX(), state.getCenterY());
      tmp = new Rectangle(tmp.x - this.refreshTarget.width / 2, tmp.y - this.refreshTarget.height / 2, this.refreshTarget.width, this.refreshTarget.height);
    ...
    else if (currentStyleTarget == null || !contains(currentStyleTarget, x, y) || (timeOnTarget > 1500 && !mxEvent.isShiftDown(evt))) {
    ...
    if (activeTarget && currentTargetState != null && !mxEvent.isAltDown(evt) && activeArrow == null) {
      ...
      if (currentTargetState.cell.isEdge()) {
        ...
        if (roundSource.parentNode != null) {
          var p0 = pts[0];
          bbox.add(
            checkArrow(x, y, new Rectangle(p0.x - this.roundDrop.width / 2, p0.y - this.roundDrop.height / 2, this.roundDrop.width, this.roundDrop.height), roundSource)
          );
        }
        ...
        if (roundTarget.parentNode != null) {
          let pe = pts[pts.length - 1];
          bbox.add(
            checkArrow(x, y, new Rectangle(pe.x - this.roundDrop.width / 2, pe.y - this.roundDrop.height / 2, this.roundDrop.width, this.roundDrop.height), roundTarget)
          );
        }
      } else {
        ...
        bbox.add(
          checkArrow(
            x,
            y,
            new Rectangle(currentTargetState.getCenterX() - this.triangleUp.width / 2, bds.y - this.triangleUp.height, this.triangleUp.width, this.triangleUp.height),
            arrowUp
          )
        );
        bbox.add(
          checkArrow(
            x,
            y,
            new Rectangle(bds.x + bds.width, currentTargetState.getCenterY() - this.triangleRight.height / 2, this.triangleRight.width, this.triangleRight.height),
            arrowRight
          )
        );
        bbox.add(
          checkArrow(
            x,
            y,
            new Rectangle(currentTargetState.getCenterX() - this.triangleDown.width / 2, bds.y + bds.height, this.triangleDown.width, this.triangleDown.height),
            arrowDown
          )
        );
        bbox.add(
    ...
    let validTarget =
      (firstVertex == null || cells[firstVertex].isConnectable()) && ((cell.isEdge() && firstVertex != null) || (cell.isVertex() && cell.isConnectable()));
    ...
    if (
      ...
      (currentTargetState != state && (bbox == null || !contains(bbox, x, y) || (timeOnTarget > 500 && activeArrow == null && validTarget)))
    ) {
      activeTarget = false;
      currentTargetState = (timeOnTarget < 5000 && timeOnTarget > this.dropTargetDelay) || cell.isEdge() ? state : null;
    ...
    let target =
      (!mxEvent.isAltDown(evt) || mxEvent.isShiftDown(evt)) && !(currentStyleTarget != null && activeArrow == styleTarget)
        ? DragSource.prototype.getDropTarget.apply(this, arguments)
        : null;
    ...
    if (target != null) {
      if (activeArrow != null || !graph.isSplitTarget(target, cells, evt)) {
        ...
        while (target != null && !graph.isValidDropTarget(target, cells, evt) && target.getParent().isVertex()) {
        ...
        if (
          ...
          (graph.view.currentRoot == target ||
            (!graph.isValidRoot(target) && target.getChildCount() == 0) ||
...
Sidebar.prototype.itemClicked = function (cells, ds, evt, elt) {
  ...
  if (mxEvent.isAltDown(evt) && graph.getSelectionCount() == 1 && graph.getSelectionCell().isVertex()) {
    let firstVertex = null;
  ...
  // Shift+Click updates shape
    ...
    let pt = mxEvent.isAltDown(evt) ? graph.getFreeInsertPoint() : graph.getCenterInsertPoint(graph.getBoundingBoxFromGeometry(cells, true));
...
Sidebar.prototype.addStencilPalette = function (id, title, stencilFile, style, ignore, onInit, scale, tags, customFns, groupId) {
  ...
  if (this.addStencilsToIndex) {
    ...
    StencilShapeRegistry.loadStencilSet(
      stencilFile,
