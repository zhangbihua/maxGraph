	...
	let fns = [
	    ...
	    this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Callout', null, null, 'bubble chat thought speech message'),
	 	...
	 	this.addEntry('curve', (() =>
	 	{
			...
			cell.geometry.setTerminalPoint(new Point(50, 0), false);
			cell.geometry.points = [new Point(50, 50), new Point(0, 0)];
	 	...
	 	this.addEntry(lineTags + 'edge title', (() =>
		{
			...
			edge.geometry.setTerminalPoint(new Point(100, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
			
	    	var cell0 = new Cell('Label', new Geometry(0, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=center;verticalAlign=middle;');
		...
		this.addEntry(lineTags + 'edge title multiplicity', (() =>
		{
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'endArrow=classic;html=1;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
	    	...
	    	var cell1 = new Cell('Source', new Geometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=bottom;');
		...
		this.addEntry(lineTags + 'edge title multiplicity', (() =>
		{
	    	...
	    	var cell2 = new Cell('Target', new Geometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=bottom;');
	 	...
	 	this.addEntry(lineTags + 'edge shape symbol message mail email', (() =>
		{
	    	...
	    	let cell = new Cell('', new Geometry(0, 0, 20, 14), 'shape=message;html=1;outlineConnect=0;');
	    	cell.geometry.relative = true;
	    	cell.vertex = true;
...
Sidebar.prototype.addMiscPalette = function(expand)
{
	...
	let fns = [
		...
		{
		    let cell = new Cell('Label', new Geometry(0, 0, 160, 70),
				'html=1;whiteSpace=wrap;container=1;recursiveResize=0;collapsible=0;');
		    cell.vertex = true;
		    
			let symbol = new Cell('', new Geometry(20, 20, 20, 30), 'triangle;html=1;whiteSpace=wrap;');
			symbol.vertex = true;
			cell.insert(symbol);
...
Sidebar.prototype.createAdvancedShapes = function()
{
	...
	// Reusable cells
	let field = new Cell('List Item', new Geometry(0, 0, 60, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	...
	return [
		...
		{
			let cell = new Cell('List', new Geometry(0, 0, 140, 110),
...
Sidebar.prototype.addUmlPalette = function(expand)
{
	...
	// Reusable cells
	let field = new Cell('+ field: type', new Geometry(0, 0, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;

	let divider = new Cell('', new Geometry(0, 0, 40, 8), 'line;strokeWidth=1;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=3;spacingRight=3;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
	divider.vertex = true;
	...
	let fns = [
		...
		{
			let cell = new Cell('Classname', new Geometry(0, 0, 160, 90),
		...
		{
			let cell = new Cell('Classname', new Geometry(0, 0, 140, 110),
		...
		this.addEntry(dt + 'item member method function variable field attribute label', function()
		{
   		...
   		this.addEntry(dt + 'item member method function variable field attribute label', function()
		{
   			let cell = new Cell('item: attribute', new Geometry(0, 0, 120, field.geometry.height), 'label;fontStyle=0;strokeColor=none;fillColor=none;align=left;verticalAlign=top;overflow=hidden;' +
		...
		{
			let cell = new Cell('', new Geometry(0, 0, 20, 14), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingTop=-1;spacingLeft=4;spacingRight=4;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;');
			cell.vertex = true;
		...
		{
		    let cell = new Cell('&laquo;Annotation&raquo;<br/><b>Component</b>', new Geometry(0, 0, 180, 90), 'html=1;dropTarget=0;');
		    cell.vertex = true;
		    
			let symbol = new Cell('', new Geometry(1, 0, 20, 20), 'shape=module;jettyWidth=8;jettyHeight=4;');
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new Point(-27, 7);
			cell.insert(symbol);
		...
		this.addEntry(dt + 'component', function()
		{
		    let cell = new Cell('<p style="margin:0px;margin-top:6px;text-align:center;"><b>Component</b></p>' +
				'<hr/><p style="margin:0px;margin-left:8px;">+ Attribute1: Type<br/>+ Attribute2: Type</p>', new Geometry(0, 0, 180, 90),
				'align=left;overflow=fill;html=1;dropTarget=0;');
		    cell.vertex = true;
		    
			let symbol = new Cell('', new Geometry(1, 0, 20, 20), 'shape=component;jettyWidth=8;jettyHeight=4;');
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new Point(-24, 4);
			cell.insert(symbol);
		...
		this.addEntry(dt + 'object instance', function()
		{
		    let cell = new Cell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
	    			'<b>Class</b></p>' +
					'<hr size="1"/><div style="height:2px;"></div>', new Geometry(0, 0, 140, 60),
		...
		this.addEntry(dt + 'object instance', function()
		{
		    let cell = new Cell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
	    			'<b>Class</b></p>' +
					'<hr size="1"/><div style="height:2px;"></div><hr size="1"/><div style="height:2px;"></div>', new Geometry(0, 0, 140, 60),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		this.addEntry(dt + 'object instance', function()
		{
		    let cell = new Cell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
					...
					'<p style="margin:0px;margin-left:4px;">+ method(): Type</p>', new Geometry(0, 0, 160, 90),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		this.addEntry(dt + 'object instance', function()
		{
		    let cell = new Cell('<p style="margin:0px;margin-top:4px;text-align:center;">' +
					...
					'+ method2(Type, Type): Type</p>', new Geometry(0, 0, 190, 140),
					'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
		    cell.vertex = true;
		...
		{
	    	let cell = new Cell('', new Geometry(0, 0, 30, 30),
	    		'ellipse;html=1;shape=startState;fillColor=#000000;strokeColor=#ff0000;');
	    	cell.vertex = true;
	    	
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new Point(15, 90), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
			let cell = new Cell('Activity', new Geometry(0, 0, 120, 40),
				'rounded=1;whiteSpace=wrap;html=1;arcSize=40;fontColor=#000000;fillColor=#ffffc0;strokeColor=#ff0000;');
			cell.vertex = true;
			
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new Point(60, 100), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
			let cell = new Cell('Composite State', new Geometry(0, 0, 160, 60),
			...
			var cell1 = new Cell('Subtitle', new Geometry(0, 0, 200, 26), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;whiteSpace=wrap;overflow=hidden;rotatable=0;fontColor=#000000;');
			cell1.vertex = true;
			cell.insert(cell1);
			
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new Point(80, 120), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
	    	let cell = new Cell('Condition', new Geometry(0, 0, 80, 40), 'rhombus;whiteSpace=wrap;html=1;fillColor=#ffffc0;strokeColor=#ff0000;');
	    	cell.vertex = true;
	    	
			var edge1 = new Cell('no', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge1.geometry.setTerminalPoint(new Point(180, 20), false);
			...
			var edge2 = new Cell('yes', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;verticalAlign=top;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge2.geometry.setTerminalPoint(new Point(40, 100), false);
		...
		{
	    	let cell = new Cell('', new Geometry(0, 0, 200, 10), 'shape=line;html=1;strokeWidth=6;strokeColor=#ff0000;');
	    	cell.vertex = true;
			
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;verticalAlign=bottom;endArrow=open;endSize=8;strokeColor=#ff0000;');
			edge.geometry.setTerminalPoint(new Point(100, 80), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
	    	let cell = new Cell('', new Geometry(0, 0, 10, 80), 'html=1;points=[];perimeter=orthogonalPerimeter;');
	    	cell.vertex = true;
	    	
			let edge = new Cell('dispatch', new Geometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;startArrow=oval;endArrow=block;startSize=8;');
			edge.geometry.setTerminalPoint(new Point(-60, 0), true);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		this.addEntry('uml sequence invoke call delegation synchronous invocation activation', function()
		{
			...
			var edge1 = new Cell('dispatch', new Geometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=block;entryX=0;entryY=0;');
			edge1.geometry.setTerminalPoint(new Point(-70, 0), true);
			edge1.geometry.relative = true;
			edge1.edge = true;

			cell.insertEdge(edge1, false);
			
			var edge2 = new Cell('return', new Geometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;exitX=0;exitY=0.95;');
			edge2.geometry.setTerminalPoint(new Point(-70, 76), false);
			edge2.geometry.relative = true;
			edge2.edge = true;
		...
		{
	    	let cell = new Cell('', new Geometry(0, 20, 10, 40), 'html=1;points=[];perimeter=orthogonalPerimeter;');
	    	cell.vertex = true;
	
			let edge = new Cell('self call', new Geometry(0, 0, 0, 0), 'edgeStyle=orthogonalEdgeStyle;html=1;align=left;spacingLeft=2;endArrow=block;rounded=0;entryX=1;entryY=0;');
			edge.geometry.setTerminalPoint(new Point(5, 0), true);
			edge.geometry.points = [new Point(30, 0)];
			edge.geometry.relative = true;
			edge.edge = true;
		...
		this.addEntry('uml sequence self call recursion delegation activation', function()
		{
	    	let cell = new Cell('Constraint1 specification', new Geometry(0, 0, 160, 60), 'shape=note2;boundedLbl=1;whiteSpace=wrap;html=1;size=25;verticalAlign=top;align=center;');
	    	cell.vertex = true;
	    	let label = new Cell('<<keyword>>', new Geometry(0, 0, cell.geometry.width, 25), 'resizeWidth=1;part=1;strokeColor=none;fillColor=none;align=left;spacingLeft=5;');
		...
		{
	 		var cell1 = new Cell('&lt;&lt;keyword&gt;&gt;<br><b>Classifier1</b><br>{abstract}', new Geometry(0, 0, 140, 183),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('attributes',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		var field2 = new Cell('attribute1',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		var field3 = new Cell('inherited attribute2',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;fontColor=#808080;');
	 		field3.vertex = true;
	 		cell1.insert(field3);
	 		var field4 = new Cell('...',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
			...
			cell1.insert(divider.clone());
	 		var field5 = new Cell('operations',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field5.vertex = true;
	 		cell1.insert(field5);
	 		var field6 = new Cell('operation1',
	 				new Geometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field6.vertex = true;
	 		cell1.insert(field6);
		...
		this.createVertexTemplateEntry('shape=process;fixedSize=1;size=5;fontStyle=1;', 140, 40, 'Classifier1', 'Classifier', null, null, 'classifier'),
	 	...
	 	this.addEntry(dt + 'classifier', function()
		{
	 		var cell1 = new Cell('Classifier1', new Geometry(0, 0, 140, 183),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('internal structure',
	 				new Geometry(0, 0, 140, 30), 'html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;rotatable=0;points=[[0,0.5],[1,0.5]];resizeWidth=1;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		
	 		var cell2 = new Cell('', new Geometry(0, 0, 140, 140),
	 			'strokeColor=none;fillColor=none;');
			cell2.vertex = true;
	 		cell1.insert(cell2);
	 		
	 		var field2 = new Cell('property1',
	 				new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field2.geometry.relative = true;
	 		field2.geometry.offset = new Point(20, 20);
	 		field2.vertex = true;
	 		cell2.insert(field2);
	 		
	 		var field3 = new Cell('property2',
	 				new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field3.geometry.relative = true;
	 		field3.geometry.offset = new Point(20, 90);
	 		field3.vertex = true;
	 		cell2.insert(field3);
	 		
	    	var assoc1 = new Cell('connector1', new Geometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;exitX=0.15;exitY=1;entryX=0.15;entryY=0;spacingLeft=4;');
		...
		this.createVertexTemplateEntry('fontStyle=1;', 140, 30, 'Association1', 'Association', null, null, 'association'),
	 	...
	 	this.addEntry(dt + 'classifier', function()
		{
	 		var cell1 = new Cell('Instance1', new Geometry(0, 0, 140, 138),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('slot1',
	 				new Geometry(0, 0, 140, 30), 'html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;rotatable=0;points=[[0,0.5],[1,0.5]];resizeWidth=1;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		
			cell1.insert(divider.clone());
			
	 		var field2 = new Cell('internal structure',
	 				new Geometry(0, 0, 140, 20), 'html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;rotatable=0;points=[[0,0.5],[1,0.5]];resizeWidth=1;');
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		
	 		var cell2 = new Cell('', new Geometry(0, 0, 140, 50),
	 			'strokeColor=none;fillColor=none;');
			cell2.vertex = true;
	 		cell1.insert(cell2);
	 		
	 		var field3 = new Cell('instance2',
	 				new Geometry(0, 0, 80, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field3.geometry.relative = true;
	 		field3.geometry.offset = new Point(30, 10);
	 		field3.vertex = true;
	 		cell2.insert(field3);
		...
		this.createVertexTemplateEntry('fontStyle=0;', 120, 40, 'Instance1 value', 'Instance', null, null, 'instance'),
	 	...
	 	this.addEntry(dt + 'classifier', function()
		{
	 		var cell1 = new Cell('&lt;&lt;enumeration&gt;&gt;<br><b>Enum1</b>', new Geometry(0, 0, 140, 70),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('literal1',
	 				new Geometry(0, 0, 140, 30), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 	...
	 	this.addEntry(dt + 'classifier', function()
		{
	 		var cell1 = new Cell('0..1', new Geometry(0, 0, 120, 50),
	 			'align=right;verticalAlign=top;spacingRight=2;');
			cell1.vertex = true;
	 		var field1 = new Cell('Property1',
	 				new Geometry(0, 1, 120, 30), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;resizeWidth=1;');
	 		field1.geometry.relative = true;
	 		field1.geometry.offset = new Point(0, -30);
	 		field1.vertex = true;
		...
		this.addEntry(dt + 'component', function()
		{
		    var cell1 = new Cell('', new Geometry(0, 0, 140, 200), 'fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;marginBottom=0;');
		    cell1.vertex = true;
		    
		    var cell2 = new Cell('Component', new Geometry(0, 0, 140, 40), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell2.vertex = true;
		    cell1.insert(cell2);
		    
			let symbol = new Cell('', new Geometry(1, 0, 16, 20), 'shape=module;jettyWidth=10;jettyHeight=4;');
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new Point(-25, 9);
			cell2.insert(symbol);

			cell1.insert(divider.clone());

		    var cell3 = new Cell('provided interfaces', new Geometry(0, 0, 140, 25), 'html=1;align=center;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell3.vertex = true;
		    cell1.insert(cell3);

		    var cell4 = new Cell('Interface1', new Geometry(0, 0, 140, 25), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell4.vertex = true;
		    cell1.insert(cell4);

			cell1.insert(divider.clone());
			
		    var cell5 = new Cell('required interfaces', new Geometry(0, 0, 140, 25), 'html=1;align=center;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell5.vertex = true;
		    cell1.insert(cell5);

		    var cell6 = new Cell('Interface2', new Geometry(0, 0, 140, 30), 'html=1;align=left;spacingLeft=4;verticalAlign=top;strokeColor=none;fillColor=none;');
		    cell6.vertex = true;
		    cell1.insert(cell6);
	 	...
	 	this.addEntry(dt + 'classifier', function()
		{
	 		var cell1 = new Cell('', new Geometry(0, 0, 270, 230),
			...
			cell1.vertex = true;
	 		...
	 		var field1 = new Cell('Collaboration1',
	 				new Geometry(0, 0, 270, 30), 'html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;rotatable=0;points=[[0,0.5],[1,0.5]];resizeWidth=1;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		
	 		var divider1 = new Cell('', new Geometry(0.145, 0, 192, 8), 'line;strokeWidth=1;fillColor=none;rotatable=0;labelPosition=right;points=[];portConstraint=eastwest;dashed=1;resizeWidth=1;');
	 		divider1.geometry.relative = true;
	 		divider1.geometry.offset = new Point(0, 30);
	 		divider1.vertex = true;
	 		cell1.insert(divider1);
	 		
	 		var field2 = new Cell('Classifier1',
	 				new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field2.geometry.relative = true;
	 		field2.geometry.offset = new Point(85, 50);
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		
	 		var field3 = new Cell('Collaboration use 1',
	 				new Geometry(0, 0, 140, 30), 'shape=ellipse;html=1;align=center;verticalAlign=middle;rotatable=0;dashed=1;');
	 		field3.geometry.relative = true;
	 		field3.geometry.offset = new Point(65, 110);
	 		field3.vertex = true;
	 		cell1.insert(field3);
	 		
	    	var assoc1 = new Cell('property1', new Geometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;spacingLeft=4;');
	    	assoc1.geometry.relative = true;
	    	assoc1.edge = true;
	    	field2.insertEdge(assoc1, true);
	    	field3.insertEdge(assoc1, false);
	    	cell1.insert(assoc1);
	 		...
	 		var field4 = new Cell('Classifier2',
	 				new Geometry(0, 0, 100, 30), 'html=1;align=center;verticalAlign=middle;rotatable=0;');
	 		field4.geometry.relative = true;
	 		field4.geometry.offset = new Point(85, 170);
	 		field4.vertex = true;
	 		cell1.insert(field4);
	 		
	    	var assoc2 = new Cell('property1', new Geometry(0, 0, 0, 0), 'edgeStyle=none;endArrow=none;verticalAlign=middle;labelBackgroundColor=none;endSize=12;html=1;align=left;endFill=0;spacingLeft=4;');
		...
		{
	 		var cell1 = new Cell('Package1', new Geometry(0, 0, 150, 100),
	 			'shape=folder;fontStyle=1;tabWidth=110;tabHeight=30;tabPosition=left;html=1;boundedLbl=1;labelInHeader=1;');
			cell1.vertex = true;
			
	 		var field1 = new Cell('Packaged element1',
	 				new Geometry(0, 0, 110, 30), 'html=1;');
	 		field1.geometry.relative = true;
	 		field1.geometry.offset = new Point(20, 50);
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 	...
	 	this.addEntry(dt + 'package', function()
		{
	 		var cell1 = new Cell('Model1', new Geometry(0, 0, 150, 80),
		...
		{
	 		var cell1 = new Cell('', new Geometry(0, 0, 160, 75),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('&lt;&lt;stereotype1&gt;&gt;',
	 				new Geometry(0, 0, 160, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		var field2 = new Cell('stereotype property 1',
	 				new Geometry(0, 0, 160, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field2.vertex = true;
	 		cell1.insert(field2);
	 		var field3 = new Cell('stereotype property 2',
	 				new Geometry(0, 0, 160, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field3.vertex = true;
	 		cell1.insert(field3);
		...
		{
	 		var cell1 = new Cell('Class1', new Geometry(0, 0, 140, 79),
			...
			cell1.vertex = true;
	 		var field1 = new Cell('&lt;&lt;stereotype1&gt;&gt;',
	 				new Geometry(0, 0, 140, 25), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		var field2 = new Cell('stereotype property 1',
	 				new Geometry(0, 0, 140, 25), 'text;html=1;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	 		field2.vertex = true;
	 		cell1.insert(field2);
		...
		{
	 		var cell1 = new Cell('', new Geometry(60, 0, 10, 100),
	 			'line;strokeWidth=1;direction=south;html=1;dashed=1;dashPattern=20 20;');
			cell1.vertex = true;

	 		var cell2 = new Cell('Region 1', new Geometry(0, 40, 60, 20),
 				'text;align=right;');
	 		cell2.vertex = true;

	 		var cell3 = new Cell('Region 2', new Geometry(70, 40, 60, 20),
				'text;align=left;');
	 		cell3.vertex = true;
		...
		{
	 		var cell1 = new Cell('State1<br>[invariant1]<br>&lt;&lt;extended/final&gt;&gt;', new Geometry(0, 0, 140, 176),
			...
			cell1.vertex = true;
	 		...
	 		var field1 = new Cell('',
	 				new Geometry(0, 0, 140, 50), 'fillColor=none;strokeColor=none;container=1;collapsible=0;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
	 		
	 		var field2 = new Cell('State2',
	 				new Geometry(30, 10, 80, 30), 'html=1;align=center;verticalAlign=middle;rounded=1;absoluteArcSize=1;arcSize=10;');
	 		field2.vertex = true;
	 		field1.insert(field2);
	 		
			cell1.insert(divider.clone());

	 		var field3 = new Cell('behavior1',
	 				new Geometry(0, 0, 140, 25), 'fillColor=none;strokeColor=none;align=left;verticalAlign=middle;spacingLeft=5;');
	 		field3.vertex = true;
	 		cell1.insert(field3);
	 		
			cell1.insert(divider.clone());

	 		var field4 = new Cell('transition1',
	 				new Geometry(0, 0, 140, 25), 'fillColor=none;strokeColor=none;align=left;verticalAlign=middle;spacingLeft=5;');
	 		field4.vertex = true;
	 		cell1.insert(field4);
		...
		this.createVertexTemplateEntry('shape=umlState;rounded=1;verticalAlign=top;spacingTop=5;umlStateSymbol=collapseState;absoluteArcSize=1;arcSize=10;', 140, 60,
	 	...
	 	this.addEntry(dt + 'State', function()
		{
	 		var cell1 = new Cell('State1', new Geometry(40, 0, 140, 50),
			...
			cell1.vertex = true;
	 		...
	 		var field1 = new Cell('Entry1',
	 				new Geometry(0, 40, 50, 20), 'text;verticalAlign=middle;align=center;');
	 		field1.vertex = true;
	 		cell1.insert(field1);
		...
		{
			let edge = new Cell('return', new Geometry(0, 0, 0, 0), 'html=1;verticalAlign=bottom;endArrow=open;dashed=1;endSize=8;');
			edge.geometry.setTerminalPoint(new Point(80, 0), true);
			edge.geometry.setTerminalPoint(new Point(0, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		{
			let edge = new Cell('name', new Geometry(0, 0, 0, 0), 'endArrow=block;endFill=1;html=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=top;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
	    	...
	    	let cell = new Cell('1', new Geometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=bottom;');
	    	cell.geometry.relative = true;
		...
		{
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'endArrow=none;html=1;edgeStyle=orthogonalEdgeStyle;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
			
	    	var cell1 = new Cell('parent', new Geometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=bottom;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);
			
	    	var cell2 = new Cell('child', new Geometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=bottom;');
	    	cell2.geometry.relative = true;
	    	cell2.setConnectable(false);
	    	cell2.vertex = true;
	    	edge.insert(cell2);
		...
		{
			let edge = new Cell('1', new Geometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=bottom;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
		...
		{
			let edge = new Cell('1', new Geometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=bottom;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.geometry.x = -1;
		...
		this.addEntry('uml relation', function()
		{
			let edge = new Cell('Relation', new Geometry(0, 0, 0, 0), 'endArrow=open;html=1;endSize=12;startArrow=diamondThin;startSize=14;startFill=0;edgeStyle=orthogonalEdgeStyle;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(160, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
			
	    	var cell1 = new Cell('0..n', new Geometry(-1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=left;verticalAlign=top;');
	    	cell1.geometry.relative = true;
	    	cell1.setConnectable(false);
	    	cell1.vertex = true;
	    	edge.insert(cell1);
			
	    	var cell2 = new Cell('1', new Geometry(1, 0, 0, 0), 'edgeLabel;resizable=0;html=1;align=right;verticalAlign=top;');
	    	cell2.geometry.relative = true;
	    	cell2.setConnectable(false);
	    	cell2.vertex = true;
	    	edge.insert(cell2);
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
		...
		{
			let cell = new Cell('Sub-Process', new Geometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;shape=plus;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(-7, -14);
			cell.insert(cell1);
		...
		{
			let cell = new Cell('Looped\nSub-Process', new Geometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;shape=mxgraph.bpmn.loop;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(-15, -14);
			cell.insert(cell1);
			
			var cell2 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new Point(1, -14);
			cell.insert(cell2);
		...
		{
			let cell = new Cell('Receive', new Geometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0, 0, 20, 14), 'html=1;shape=message;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(7, 7);
			cell.insert(cell1);
		...
		{
			let cell = new Cell('User', new Geometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0, 0, 14, 14), 'html=1;shape=mxgraph.bpmn.user_task;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(7, 7);
			cell.insert(cell1);
			
			var cell2 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;shape=plus;outlineConnect=0;');
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new Point(-7, -14);
			cell.insert(cell2);
		...
		{
			let cell = new Cell('Process', new Geometry(0, 0, 120, 80), 'html=1;whiteSpace=wrap;rounded=1;dropTarget=0;');
			cell.vertex = true;

			var cell1 = new Cell('', new Geometry(1, 1, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;verticalLabelPosition=bottom;verticalAlign=top;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(-40, -15);
			cell.insert(cell1);
		...
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'timer_start', 'attached').join(' '), function()
		{
			...
			var cell1 = new Cell('', new Geometry(1, 0, 30, 30), 'shape=mxgraph.bpmn.timer_start;perimeter=ellipsePerimeter;html=1;labelPosition=right;align=left;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(-15, 10);
			cell.insert(cell1);
		...
		{
			let cell = new Cell('', new Geometry(0, 0, 60, 50), 'shape=hexagon;whiteSpace=wrap;html=1;perimeter=hexagonPerimeter;rounded=0;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;shape=plus;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(-7, -14);
			cell.insert(cell1);
		...
		{
			let cell = new Cell('', new Geometry(0, 0, 40, 60), 'shape=note;whiteSpace=wrap;size=16;html=1;dropTarget=0;');
			cell.vertex = true;
			
			var cell1 = new Cell('', new Geometry(0, 0, 14, 14), 'html=1;shape=singleArrow;arrowWidth=0.4;arrowSize=0.4;outlineConnect=0;');
			cell1.vertex = true;
			cell1.geometry.relative = true;
			cell1.geometry.offset = new Point(2, 2);
			cell.insert(cell1);
			
			var cell2 = new Cell('', new Geometry(0.5, 1, 14, 14), 'html=1;whiteSpace=wrap;shape=parallelMarker;outlineConnect=0;');
			cell2.vertex = true;
			cell2.geometry.relative = true;
			cell2.geometry.offset = new Point(-7, -14);
			cell.insert(cell2);
		...
		{
			let edge = new Cell('', new Geometry(0, 0, 0, 0), 'startArrow=oval;startFill=0;startSize=7;endArrow=block;endFill=0;endSize=10;dashed=1;html=1;');
			edge.geometry.setTerminalPoint(new Point(0, 0), true);
			edge.geometry.setTerminalPoint(new Point(100, 0), false);
			edge.geometry.relative = true;
			edge.edge = true;
		...
		else
		{
				...
				geo2.getTerminalPoint(false) != null)
			{
				...
				if (direction == mxConstants.DIRECTION_NORTH)
				{
					geo2.height = length
					geo2.y = geo.y - length;
					geo2.setTerminalPoint(new Point(geo2.x, geo2.y), false);
				}
				else if (direction == mxConstants.DIRECTION_EAST)
				{
					geo2.width = length
					geo2.x = geo.x + geo.width;
					geo2.setTerminalPoint(new Point(geo2.x + geo2.width, geo2.y), false);
				}
				else if (direction == mxConstants.DIRECTION_SOUTH)
				{
					geo2.height = length
					geo2.y = geo.y + geo.height;
					geo2.setTerminalPoint(new Point(geo2.x, geo2.y + geo2.height), false);
				}
...
Sidebar.prototype.createDragSource = function(elt, dropHandler, preview, cells, bounds)
{
	...
	{
		DragSource.prototype.dragOver.apply(this, arguments);
	...
	dragSource.getDropTarget = ((graph, x, y, evt) =>
	{
			...
			(state.cell.isEdge() && cells[0].isEdge())))
		{
			...
			tmp = new Rectangle(tmp.x - this.refreshTarget.width / 2, tmp.y - this.refreshTarget.height / 2,
		...
		else if (currentStyleTarget != null && styleTargetParent != null)
		{
			...
			let tmp = (currentStyleTarget.cell.isEdge()) ? graph.view.getPoint(currentStyleTarget) : new Point(currentStyleTarget.getCenterX(), currentStyleTarget.getCenterY());
			tmp = new Rectangle(tmp.x - this.refreshTarget.width / 2, tmp.y - this.refreshTarget.height / 2,
				this.refreshTarget.width, this.refreshTarget.height);
			checkArrow(x, y, tmp, styleTarget);
		}
		...
		if (activeTarget && currentTargetState != null && !mxEvent.isAltDown(evt) && activeArrow == null)
		{
			...
			bbox = Rectangle.fromRectangle(currentTargetState);
			...
			if (currentTargetState.cell.isEdge())
			{
				...
				{
					var p0 = pts[0];
					bbox.add(checkArrow(x, y, new Rectangle(p0.x - this.roundDrop.width / 2,
				...
				{
					let pe = pts[pts.length - 1];
					bbox.add(checkArrow(x, y, new Rectangle(pe.x - this.roundDrop.width / 2,
			...
			{
				let bds = Rectangle.fromRectangle(currentTargetState);
				
				// Uses outer bounding box to take rotation into account
				if (currentTargetState.shape != null && currentTargetState.shape.boundingBox != null)
				{
					bds = Rectangle.fromRectangle(currentTargetState.shape.boundingBox);
				}
				...
				bbox.add(checkArrow(x, y, new Rectangle(currentTargetState.getCenterX() - this.triangleUp.width / 2,
					bds.y - this.triangleUp.height, this.triangleUp.width, this.triangleUp.height), arrowUp));
				bbox.add(checkArrow(x, y, new Rectangle(bds.x + bds.width,
					currentTargetState.getCenterY() - this.triangleRight.height / 2,
					this.triangleRight.width, this.triangleRight.height), arrowRight));
				bbox.add(checkArrow(x, y, new Rectangle(currentTargetState.getCenterX() - this.triangleDown.width / 2,
						bds.y + bds.height, this.triangleDown.width, this.triangleDown.height), arrowDown));
				bbox.add(checkArrow(x, y, new Rectangle(bds.x - this.triangleLeft.width,
			...
			if (currentTargetState != null && validTarget)
			{
				...
				if (cell.isEdge())
				{
					...
					if (pts != null)
					{
						...
						let box = new Rectangle(x - tol, y - tol, 2 * tol, 2 * tol);
				...
				else
				{
					...
					{
						bds = Rectangle.fromRectangle(state.shape.boundingBox);
					}
	...
	{
		DragSource.prototype.stopDrag.apply(this, arguments);
...
{
	let cells = [new Cell((value != null) ? value : '', new Geometry(0, 0, width, height), style)];
	cells[0].vertex = true;
...
{
	let cell = new Cell((value != null) ? value : '', new Geometry(0, 0, width, height), style);
	cell.geometry.setTerminalPoint(new Point(0, height), true);
	cell.geometry.setTerminalPoint(new Point(width, 0), false);
	cell.geometry.relative = true;
	cell.edge = true;
